...
export const BASE_HANDLER_MESSAGES = {
  LOGGER_DEBUG : {
    ...
    GET_RECORD_FIELD_NAME_FROM_USER: 'Prompting user to enter record field name',
    ...
    INSERTING_KEEPER_REFERENCE_IN_ACTIVE_TEXT_EDITOR: 'Inserting keeper reference in active text editor',
    REPLACED_REFERENCE_IN_RANGE: 'Replaced reference in range',
    REPLACED_REFERENCE_IN_SELECTION: 'Replaced reference in selection',
    KEEPER_REFERENCE_INSERTED_SUCCESSFULLY: 'Keeper reference inserted successfully',
    ...
    CURRENT_STORAGE_VALIDATION_SUCCESSFUL: 'Current storage validation successful',
    STARTING_FOLDER_SELECTION_PROCESS: 'Starting folder selection process',
    NO_FOLDERS_AVAILABLE: 'No folders available',
    STORAGE_LOCATION_AUTOMATICALLY_SET_TO: 'Storage location automatically set to',
  ...
  LOGGER_ERROR : {
    NO_ACTIVE_TEXT_EDITOR_FOUND: 'No active text editor found. Cannot insert reference.',
    ...
    FOLDER_NO_LONGER_EXISTS_ON_KEEPER_VAULT: 'Folder no longer exists on Keeper vault',
  },
  INFO : {
    SECRET_SAVED_TO_KEEPER_VAULT: 'Secret saved to keeper vault',
    PASSWORD_GENERATED_AND_SAVED_TO_KEEPER_VAULT: 'Password generated and saved to keeper vault',
    REFERENCE_OF_FIELD_OF_SECRET_RETRIEVED_SUCCESSFULLY: 'Reference of field of secret retrieved successfully',
    RESOLVING_SECRETS: 'Resolving secrets...',
    COMMAND_STARTED_WITH_SECRETS_INJECTED: 'Command started with secrets injected',
  ...
  ERROR : {
    NO_FILE_OPEN: 'No file is open. Please open a file first to insert the reference.',
    ...
    SELECTED_FILE_IS_NOT_AN_ENVIRONMENT_FILE: 'Selected file is not an environment file. Must be a .env or .env.* file',
  ...
  INPUT : {
    ...
    RECORD_NAME_FROM_USER_PLACEHOLDER: "Enter a name for this record. e.g. 'My Password'",
    RECORD_FIELD_NAME_FROM_USER_PROMPT: 'What do you want to call this record field?',
    RECORD_FIELD_NAME_FROM_USER_PLACEHOLDER: "Enter a name for field. e.g. 'password'",
    ...
    QUICK_PICK_FOR_SELECTED_RECORD_PLACEHOLDER: 'Which field do you want to retrieve?',
    SELECT_WORKSPACE_TO_RUN_SECURELY_IN_PLACEHOLDER: 'Select workspace to run securely in',
    SELECT_ENVIRONMENT_FILE_TO_USE_PLACEHOLDER: 'Select environment file to use',
    SELECT_ENVIRONMENT_FILE_TO_USE_LABEL: 'Select Environment File',
    ENTER_COMMAND_TO_RUN_WITH_KEEPER_SECRETS_INJECTED_PROMPT: 'Enter command to run with Keeper secrets injected',
    ENTER_COMMAND_TO_RUN_WITH_KEEPER_SECRETS_INJECTED_PLACEHOLDER: 'e.g. node index.js',
    TERMINAL_NAME: 'Keeper Secure Run',
    PREVIOUSLY_SELECTED_FOLDER_IS_NO_LONGER_AVAILABLE: 'Previously selected folder is no longer available. Would you like to choose a new folder?',
    QUICK_PICK_FOR_FOLDER_SELECTION_TITLE: 'Available folders',
    QUICK_PICK_FOR_FOLDER_SELECTION_PLACEHOLDER: 'Select a folder to use as storage location while saving secrets',
  }
