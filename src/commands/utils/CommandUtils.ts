...
export class CommandUtils {
    static async getSecretNameFromUser(parentFnName: string): Promise<string> {
        logger.logDebug(`Getting secret name from user ${parentFnName && `for: ${parentFnName}`}`);
    ...
    static async getSecretFieldNameFromUser(parentFnName: string): Promise<string> {
    ...
    static getFieldType(fieldName: string): string {
        ...
        logger.logDebug(`Field "${fieldName}" defaulting to type: ${KEEPER_FIELD_TYPES.TEXT}`);
